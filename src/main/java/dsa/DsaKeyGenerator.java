...
public class DsaKeyGenerator {
    ...
    public static DsaKeys generateKeys() {
        BigInteger primeDivisor = generatePrimeNumber(160);/* LargeInteger.of(new int[]{1,0,5,8,0,4,5,2,3,5,7,1,9,5,2,5,5,9,7,1,0,6,1,6,2,7,5,0,2,1,6,7,4,7,0,8,4,0,6,5,9,4,5,0,2,4,6,8});*/
